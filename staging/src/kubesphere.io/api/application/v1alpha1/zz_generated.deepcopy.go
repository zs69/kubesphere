...
func (in *ManifestStatus) DeepCopyInto(out *ManifestStatus) {
	*out = *in
	if in.RelatedResourceStates != nil {
		in, out := &in.RelatedResourceStates, &out.RelatedResourceStates
		*out = make([]*RelatedResourceState, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(RelatedResourceState)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RelatedResourceState) DeepCopyInto(out *RelatedResourceState) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RelatedResourceState.
func (in *RelatedResourceState) DeepCopy() *RelatedResourceState {
	if in == nil {
		return nil
	}
	out := new(RelatedResourceState)
