...
import (
	...
	o11ymonitoringv1alpha1 "kubesphere.io/kubesphere/pkg/kapis/observability/monitoring/v1alpha1"
	...
	staticsv1alpha1 "kubesphere.io/kubesphere/pkg/kapis/statics/v1alpha1"
	...
	o11ymonitoring "kubesphere.io/kubesphere/pkg/simple/client/observability/monitoring"
...
type APIServer struct {
	...
	O11yMonitoringClient o11ymonitoring.Interface
...
func (s *APIServer) waitForResourceSync(ctx context.Context) error {
	...
	if multuscniInformerFactory := s.InformerFactory.MultusCniSharedInformerFactory(); multuscniInformerFactory != nil && s.Config.NetworkOptions.EnableMultusCNI {
		...
		if err := waitForCacheSync(s.KubernetesClient.Kubernetes().Discovery(),
			multuscniInformerFactory, func(resource schema.GroupVersionResource) (interface{}, error) {
				return multuscniInformerFactory.ForResource(resource)
			},
			multuscniGVRs, stopCh); err != nil {
			return err
		}
	}
