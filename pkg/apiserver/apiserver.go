...
func (s *APIServer) installKubeSphereAPIs() {
	...
	urlruntime.Must(meteringv1alpha1.AddToContainer(s.container, s.KubernetesClient.Kubernetes(), s.MonitoringClient, s.InformerFactory, s.KubernetesClient.KubeSphere(), s.RuntimeCache, s.Config.MeteringOptions, nil, s.Config.MonitoringOptions.EnableGPUMonitoring))
