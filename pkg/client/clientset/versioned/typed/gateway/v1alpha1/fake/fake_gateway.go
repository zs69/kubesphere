...
import (
	...
	v1alpha1 "kubesphere.io/api/gateway/v1alpha1"
)
...
var gatewaysResource = schema.GroupVersionResource{Group: "gateway", Version: "v1alpha1", Resource: "gateways"}

var gatewaysKind = schema.GroupVersionKind{Group: "gateway", Version: "v1alpha1", Kind: "Gateway"}
